package ca.PvPCraft.PvPAPI.utilities.Fanciful;
...
import static ca.PvPCraft.PvPAPI.utilities.Fanciful.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	public void send(Player player){
		try {
			...
			Reflection.getMethod(connection.getClass(), "sendPacket", Reflection.getNMSClass("Packet")).invoke(connection, createChatPacket(Message.Colorize(toJSONString())));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
